...
const RESERVED_FILES = ['breakers', 'proxy', 'mcp-registry', 'links', 'installed-skills', 'session-accounts', 'fleet', 'fleet-seen', 'fleet-applied', 'fleet-key', 'fleet-known', 'groups', 'budget', 'notify'];
